# Press Start: Code Your Own Arcade, Block by Block

An introductory programming course built in [MakeCode Arcade](https://arcade.makecode.com), using block-based coding so students can focus on programming **concepts** — sequencing, variables, conditionals, loops, functions — rather than syntax.

Each module teaches one concept in isolation and ends with a tiny, single-mechanic microgame that demonstrates it. Over the course of the term, those microgames come together into one playable, WarioWare-style collection.
...
Part of the programming curriculum for [The Technology Access Project](https://technologyaccessproject.com) (TAP), a nonprofit focused on making coding, robotics, and technology education reachable for kids regardless of income, school, or schedule.